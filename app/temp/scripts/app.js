...
/***/ function(module, exports, __webpack_require__) {
	...
	var _pianokeyboard = __webpack_require__(2);
	...
	keys.forEach(function (key) {
	  return key.addEventListener('transitionend', _pianokeyboard.removeTransition);
	});

	window.addEventListener('keydown', _pianokeyboard.playSound);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function playSound(e) {
	    ...
	    var key = document.querySelector('kbd[data-key="' + e.keyCode + '"]');
